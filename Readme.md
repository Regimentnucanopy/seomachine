...
> Seomachine SDK — A lightweight, zero-dependency utility layer for async state management in modern JavaScript applications.
...
```javascript
const { useAsyncState } = require('seomachine');
...
MIT © Copyright (c) 2026 Seomachine, Inc.
